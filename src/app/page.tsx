        ...
        {mode === "food" ? (
          <div className="bg-white rounded-2xl shadow-lg p-6 max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full bg-orange-500 text-white font-semibold py-3.5 rounded-xl hover:bg-orange-600 transition mt-2">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              <select className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-400">
                <option>Small package (up to 5kg)</option>
                <option>Medium package (5-15kg)</option>
                <option>Large package (15kg+)</option>
              </select>
              <button className="w-full bg-orange-500 text-white font-semibold py-3.5 rounded-xl hover:bg-orange-600 transition mt-2">
                Get Instant Quote
              </button>
